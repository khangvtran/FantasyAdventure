...
public:
    ...
    std::unordered_map<string, ITEMS> itemContainer {
        ...
        {"Iron Dagger", IRONDAGGER}, {"Steel Dagger", STEELDAGGER}, {"Mithril Dagger", MITHRILDAGGER}, {"Adamantine Dagger", ADAMANTINEDAGGER}, {"Ruby", RUBY},
